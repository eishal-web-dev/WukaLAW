            ...
            <Card className="p-5 space-y-5 border-[#D4AF37]/15 bg-[#D4AF37]/[0.02]">
              <div>
                ...
                <div className="text-[11px] text-muted-foreground mt-1">
                  {[brief.court, brief.case_number].filter(Boolean).join(' · ')} · {brief.passages_reviewed} indexed passages reviewed
                </div>
              </div>
              ...
              <div className="rounded-xl border border-emerald-500/15 bg-emerald-500/[0.03] p-4 space-y-4">
                ...
                <ListBlock title="Similarities" items={brief.similarities_to_client} />
                <ListBlock title="Important differences / limits" items={brief.important_differences} />
                <ListBlock title="How it may help the client" items={brief.how_it_may_help} />
              </div>

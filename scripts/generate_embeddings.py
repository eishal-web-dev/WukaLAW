...
def main(argv=None):
    ...
    try:
        provider=create_provider(a.model,a.device,a.model_revision,cache_dir=a.cache_dir,local_files_only=a.offline,download_timeout=a.download_timeout,retries=a.download_retries,max_input_tokens=a.max_input_tokens)

...
def test_overfetch_judgment_only_and_filters():
 ...
 # source_datasets is intentionally empty: similar-case search now spans all
 # judgment datasets (commit "search all judgment datasets"), restricted by
 # document_type rather than a single dataset name.

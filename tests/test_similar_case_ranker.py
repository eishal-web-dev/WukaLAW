...
def hit(doc="d1",cid="c1",score=.8,chunk="case_header",laws=None,sections=None,articles=None,text="This criminal appeal judgment concerns section 302 and the grant of bail to the accused.",outcome=None,payload=None):return LegalSearchResult(1,score,cid,[cid],doc,"Case "+doc,"path","judgments","judgment","High Court","Pakistan","Criminal Appeals",None,chunk,None,None,None,"English",text,outcome,[],laws or [],sections or [],articles or [],[],payload or {},[])

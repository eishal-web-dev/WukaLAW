...
def hit(doc="d1",cid="c1",score=.8,chunk="case_header",laws=None,sections=None,articles=None,text="text",outcome=None,payload=None):return LegalSearchResult(1,score,cid,[cid],doc,"Case "+doc,"path","judgments","judgment","High Court","Pakistan","Criminal Appeals",None,chunk,None,None,None,"English",text,outcome,[],laws or [],sections or [],articles or [],[],payload or {},[])

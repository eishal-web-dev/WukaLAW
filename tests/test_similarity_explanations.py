...
def test_explanation_is_deterministic_and_guarded():
 ...
 # guardrail must stay: names the shared factor, disclaims prediction, never promises a win
 assert "shared section 302" in text and "not a prediction" in text and "win" not in text
